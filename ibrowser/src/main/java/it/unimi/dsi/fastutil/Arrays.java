 ...
 *
 * <p>
 * In addition to commodity methods, this class contains {@link Swapper}-based implementations of
 * {@linkplain #quickSort(int, int, IntComparator, Swapper) quicksort} and of a stable, in-place
 * {@linkplain #mergeSort(int, int, IntComparator, Swapper) mergesort}. These generic sorting
 * methods can be used to sort any kind of list, but they find their natural usage, for instance, in
...
public class Arrays {
   ...
   *                                        <code>offset</code>+<code>length</code> is greater than
  ...
  public static void ensureOffsetLength(final int arrayLength, final int offset, final int length) {
    ...
    if (offset + length > arrayLength)
      throw new ArrayIndexOutOfBoundsException("Last index (" + (offset + length)
          + ") is greater than array length (" + arrayLength + ")");
  }
  ...
  /**
   * Sorts the specified range of elements using the specified swapper and according to the order
   ...
   * @param c       the comparator to determine the order of the generic data (arguments are
   *                positions).
   * @param swapper an object that knows how to swap the elements at any two positions.
   */
  public static void mergeSort(final int from, final int to, final IntComparator c,
      final Swapper swapper) {
    /*
     * We retain the same method signature as quickSort. Given only a comparator and swapper we do
     * not know how to copy and move elements from/to temporary arrays. Hence, in contrast to the
     * JDK mergesorts this is an "in-place" mergesort, i.e. does not allocate any temporary arrays.
     * A non-inplace mergesort would perhaps be faster in most cases, but would require
   ...
   * 
   */
  public static void quickSort(final int from, final int to, final IntComparator comp,
      final Swapper swapper) {
