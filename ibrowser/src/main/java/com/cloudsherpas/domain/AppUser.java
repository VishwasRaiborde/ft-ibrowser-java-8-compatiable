...
public class AppUser extends BaseEntity {
  ...
  /*
   * @Persistent private List<Key> favouriteReportsKey;
   */
  ...
  /*
   * public List<Key> getFavouriteReportsKey() { if (favouriteReportsKey == null) {
   * favouriteReportsKey = new ArrayList<Key>(); } return favouriteReportsKey; } public void
   * setFavouriteReportsKey(List<Key> favouriteReportsKey) { this.favouriteReportsKey =
   * favouriteReportsKey; }
   */
