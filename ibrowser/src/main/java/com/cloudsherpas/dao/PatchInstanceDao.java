...
public class PatchInstanceDao extends BaseDao<PatchInstance> {
	...
	public List<PatchInstance> getReportDates(String reportKey, String groupCode, ReportPeriodEnum reportPeriodEnum) {
		return getReportDates(reportKey, groupCode, reportPeriodEnum, new Date());
	}
	
	public List<PatchInstance> getReportDates(String reportKey, String groupCode, ReportPeriodEnum reportPeriodEnum, Date date) {
		...
		try {
			List<PatchInstance> instanceList = (List<PatchInstance>) instanceQuery.executeWithArray(reportPeriodEnum, reportKey, groupCode, date);
			return instanceList;
		} finally {
//			instanceQuery.closeAll();
	...
	public List<PatchInstance> getReportDates(String reportKey, ReportPeriodEnum reportPeriodEnum, Date date) {
		PersistenceManager pm = getPersistenceManager();
		...
		instanceQuery.setOrdering("date DESC");
		try {
			List<PatchInstance> instanceList = (List<PatchInstance>) instanceQuery.executeWithArray(reportPeriodEnum, reportKey, date);
			return instanceList;
		} finally {
//			instanceQuery.closeAll();
			pm.close();
	...
	public List<PatchInstance> getPatchInstancesByRangeForDelete(String reportCode, Date dateBefore, int startIndex, int endIndex) {
		PersistenceManager pm = getPersistenceManager();
		Query q = pm.newQuery(PatchInstance.class);
	...
	public List<PatchInstance> getLastPatchInstances(String code, String groupCode, ReportPeriodEnum reportPeriodEnum) {
		PersistenceManager pm = getPersistenceManager();
		...
		try {
			List<PatchInstance> instanceList = (List<PatchInstance>) instanceQuery.executeWithArray(reportPeriodEnum, code, groupCode, new Date());
			return instanceList;
		} finally {
//			instanceQuery.closeAll();
			pm.close();
	...
	public List<PatchInstance> getLastTradingPeriodPatchInstances(String code, String groupCode, ReportPeriodEnum reportPeriodEnum, Date[] range) {
		PersistenceManager pm = getPersistenceManager();
		...
		try {
			List<PatchInstance> instanceList = (List<PatchInstance>) instanceQuery.executeWithArray(reportPeriodEnum, code, groupCode, range[0], range[1]);
			return instanceList;
		} finally {
//			instanceQuery.closeAll();
			pm.close();
	...
	public List<PatchInstance> getPatchInstancesByAfterTheDate( ReportPeriodEnum reportPeriodEnum, long start, long end) {
		PersistenceManager pm = getPersistenceManager();
...
//		instanceQuery.setFilter("period == :periodParam");
		...
		try {
			List<PatchInstance> instanceList = (List<PatchInstance>) instanceQuery.executeWithArray(reportPeriodEnum);
			return instanceList;
		} finally {
//			instanceQuery.closeAll();
			pm.close();
