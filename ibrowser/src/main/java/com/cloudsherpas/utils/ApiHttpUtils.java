...
public class ApiHttpUtils {
	...
	public Object readPost(HttpServletRequest req, @SuppressWarnings("rawtypes") Class clazz) throws IOException {
	...
	public void postBackMessage(HttpServletResponse resp, Object obj) throws IOException{
		...
		out.print(json);
		out.println(";");
		out.println("function postResponse() { window.parent.postMessage(JSON.stringify(response), '*'); }");
		out.println("</script>");
		out.println("</head>");
