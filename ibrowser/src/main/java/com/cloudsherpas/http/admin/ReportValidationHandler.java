...
public class ReportValidationHandler {
  ...
  public void get(String key, String code, HttpServletRequest req, HttpServletResponse resp)
      throws IOException {

  }

  public void post(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ReportValidationRequest vr = (ReportValidationRequest) utils.readPost(req,
        ReportValidationRequest.class);
    String key = vr.key;
    String code = vr.code;
