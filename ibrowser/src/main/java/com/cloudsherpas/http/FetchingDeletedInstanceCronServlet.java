...
public class FetchingDeletedInstanceCronServlet extends HttpServlet {

  @Override
  protected void service(HttpServletRequest arg0, HttpServletResponse arg1)
      throws ServletException, IOException {
    Queue queue = QueueFactory.getQueue("AppQueue2");
    TaskOptions taskOptions = TaskOptions.Builder.withUrl("/fetching-deleted-file-to-incoming")
        .header("Host",
