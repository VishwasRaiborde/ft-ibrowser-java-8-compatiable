...
import com.cloudsherpas.http.LeapYearPatchCronServlet;
import com.cloudsherpas.http.LeapYearPatchCronServlet2;
...
public class CsServletModule extends ServletModule{
	...
	protected void configureServlets() {
	    ...
	    filter(GlobalConstants.APP_ROOT + "*", GlobalConstants.TASK_QUEUE + "*").through(AppAuthFilter.class);
