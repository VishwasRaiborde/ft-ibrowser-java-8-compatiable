...
//	public static final String ADMIN_GROUP_NOUPPERCASE = "iBrowser Admins";
  ...
  // public static final String PRIMARY_TEST_LOGIN =
  ...
  // public static final String PRODUCTION_LOGIN =
...
//    public static final String TEST_LOGIN = "https://jlp-login.appspot.com/user/login/accountlogin?param=H4sIAAAAAAAAAF1R2a6jRhT8F0uTF2cuZrGBiawIY4zZbVbDSwRtaPZmafDFo%2Fx7mBkpiiKdl1KdqpKqvm8cwdDttJ%2FSEW%2B%2BbTJfV93ReEn6ruTu24DlW03rR1UrTpIaxcoJsuAhp6A5dxTnQpM4k5MIFQvc3DdHzrLxJtnD242gZNaud3hbmieVukgaFWldD9NwUJ30kmHW2zrPx2BGLDm%2FBY3jkZjlnSdRj8nZPZkoKmEfMfYOcoyCowHQyUlrE4saMaf2zhQ%2FLD8w67oL%2B8j1vP5T0sNAsLEtY0qPhg4F9ew7z0hzugMfVhQ1WoFyA4yVyp9baJ4nY4cMdIubRXRHJsKtbSyPuuOtvTGMMsH5MVuVytBPfWkMrO16WnK5m2xxeAG%2BCymqUPKUovjCv%2FrqKDgHxtbUKoezkTOKR1LXDF4mgXLGc%2FnakVawJR6LqlaykjDBkuRLiHEZRqfQLa%2BEM%2BRCU32WXWqen9Rtyg5ZSxP73VZPwmjgKhFtZ4pOonYfBT0tWfu6S0Kgn%2FjlqmGWRKDxnzZNZyyugRsWPWIrRw74l%2Bspqv3watG9vOcHnSEHb%2B%2FCcfP7xk7reHFwjNN17xzjbvxGEDEAaGrx%2BAERgnX6AVBDiHkK1nxUFemfALW4aKf0%2BK%2Bg69IWFm36X8VfcU6sn1mNVuZ%2Fmi%2B08IW6rFc0HRqLFn7NPr8y3P5jdRo7hH8YrOyKfoub7o8xf2ZHsbjrEozyWN7nSeDFslyLoOFpQPmLInWGcjktcUDmoK2gL%2Fvvp%2FByhOaClNyxFwTjJKeYIOH74mQFQXgG8HrTxAWejNyp02bGd7Tk3EGiB91Ab%2B%2B%2Bn%2BfWLO6%2F8tNhLkB6jPOfsMZNVx9hs%2FZ3Rk1ctGbc%2FOiPKV22GF%2BeeFe3ODDfKlmYGB7Xnv%2F%2BBzHtdEFbAwAA";
  ...
  public static String DEV_ACCOUNT_USER = "ibrowser@johnlewis.co.uk";
  public static String TEST_ACCOUNT_USER = "ibrowser@johnlewis.co.uk";
//	public static String TEST_ACCOUNT_USER = "Ash@test.johnlewis.co.uk";
  public static String PRIMARY_TEST_ACCOUNT_USER = "ibrowser@johnlewis.co.uk";
  public static String PRODUCTION_ACCOUNT_USER = "ibrowser@johnlewis.co.uk";
//	public static String PRODUCTION_ACCOUNT_USER = "ibrowser@johnlewis.co.uk";

  /* PRIMARY TEST */
  /*
   * public static final String SERVICE_ACCOUNT_ID = PRIMARY_TEST_SERVICE_ACCOUNT_ID; public static
   * final String SERVICE_ACCOUNT_PKCS12_FILE_PATH = PRIMARY_TEST_SERVICE_ACCOUNT_PKCS12_FILE_PATH;
   * public static final String ACCOUNT_USER = PRIMARY_TEST_ACCOUNT_USER; public static final String
   * PROJECT_NAME = PRIMARY_TEST_PROJECT_NAME; public static final String INCOMING_BUCKET =
   * PRIMARY_TEST_INCOMING_BUCKET; public static final String REPORTS_BUCKET =
   * PRIMARY_TEST_REPORTS_BUCKET; public static final String DELETED_BUCKET =
   * PRIMARY_TEST_DELETED_BUCKET; public static final String ERRORS_BUCKET =
   * PRIMARY_TEST_ERRORS_BUCKET; public static final String GCS_BUCKET_NAME =
   * PRIMARY_TEST_GCS_BUCKET_NAME; public static final String LOGIN = PRIMARY_TEST_LOGIN; public
   * static String MESSAGE_OF_THE_DAY_IMAGES = "ptest_message_of_day_images";
   * 
   * 
   * public static final String DOMAIN = "johnlewis.co.uk"; public static final String FROM_EMAIL =
   * "cloudsherpas.dev@johnlewis.co.uk"; public static final String TO_EMAIL =
   * "cloudsherpas.dev@johnlewis.co.uk,JL_Information_Systems@johnlewis.co.uk";
   */
...
//	/*
  ...
  public static final String FROM_EMAIL = "ibrowser@johnlewis.co.uk ";
  public static final String TO_EMAIL = "ibrowser@johnlewis.co.uk ,ibrowser@johnlewis.co.uk ";
//	*/

  /* TEST - no longer in use */
  /*
   * public static final String SERVICE_ACCOUNT_ID = TEST_SERVICE_ACCOUNT_ID; public static final
   * String SERVICE_ACCOUNT_PKCS12_FILE_PATH = TEST_SERVICE_ACCOUNT_PKCS12_FILE_PATH; public static
   * final String ACCOUNT_USER = TEST_ACCOUNT_USER; public static final String PROJECT_NAME =
   * TEST_PROJECT_NAME; public static final String INCOMING_BUCKET = TEST_INCOMING_BUCKET; public
   * static final String REPORTS_BUCKET = TEST_REPORTS_BUCKET; public static final String
   * DELETED_BUCKET = TEST_DELETED_BUCKET; public static final String ERRORS_BUCKET =
   * TEST_ERRORS_BUCKET; public static final String GCS_BUCKET_NAME = TEST_GCS_BUCKET_NAME; public
   * static final String LOGIN = TEST_LOGIN;
   * 
   * public static String MESSAGE_OF_THE_DAY_IMAGES = "test_message_of_day_images"; // public static
   * final String DOMAIN = "dev.johnlewis.co.uk"; // public static final String DOMAIN =
   * "test.johnlewis.co.uk"; public static final String DOMAIN = "johnlewis.co.uk"; public static
   * final String FROM_EMAIL = "cloudsherpas.dev@johnlewis.co.uk"; public static final String
   * TO_EMAIL = "cloudsherpas.dev@johnlewis.co.uk,JL_Information_Systems@johnlewis.co.uk"; //
   */

  /* DEV - no longer in use */
  /*
   * public static final String SERVICE_ACCOUNT_ID = DEV_SERVICE_ACCOUNT_ID; public static final
   * String SERVICE_ACCOUNT_PKCS12_FILE_PATH = DEV_SERVICE_ACCOUNT_PKCS12_FILE_PATH; public static
   * final String ACCOUNT_USER = DEV_ACCOUNT_USER; public static final String PROJECT_NAME =
   * DEV_PROJECT_NAME; public static final String INCOMING_BUCKET = DEV_INCOMING_BUCKET; public
   * static final String REPORTS_BUCKET = DEV_REPORTS_BUCKET; public static final String
   * DELETED_BUCKET = DEV_DELETED_BUCKET; public static final String ERRORS_BUCKET =
   * DEV_ERRORS_BUCKET; public static final String GCS_BUCKET_NAME = DEV_GCS_BUCKET_NAME; public
   * static final String LOGIN = DEV_LOGIN;
   * 
   * public static final String DOMAIN = "dev.johnlewis.co.uk"; public static final String
   * FROM_EMAIL = "cloudsherpas.dev@johnlewis.co.uk"; public static final String TO_EMAIL =
   * "cloudsherpas.dev@johnlewis.co.uk,JL_Information_Systems@johnlewis.co.uk";
   */
  ...
  public static final List<IPRangeItem> IP_RANGES = Arrays.asList(
      ...
      new IPRangeItem("10.20.34.54", "10.20.34.54"), new IPRangeItem("127.0.0.1", "127.0.0.1"));
}
