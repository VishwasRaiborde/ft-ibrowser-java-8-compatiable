...
public class SendMail implements GlobalConstants {
  ...
  public static void sendEmail(String fromEmail, String toEmail, String subject,
      String messageBody) {
    ...
    try {
      ...
      List<InternetAddress> addresses = Arrays.asList(new InternetAddress(recipients[0]),
